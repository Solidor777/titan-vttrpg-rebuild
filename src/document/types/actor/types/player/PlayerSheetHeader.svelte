<script>
   ...
   import CharacterSheetAttributes from '~/document/types/actor/types/character/sheet/header/CharacterSheetAttributes.svelte';
   import CharacterSheetResistances from '~/document/types/actor/types/character/sheet/header/CharacterSheetResistances.svelte';
   import ModTag from '~/helpers/svelte-components/tag/ModTag.svelte';
   import CharacterSheetInspiration from '~/document/types/actor/types/character/sheet/header/CharacterSheetInspiration.svelte';
