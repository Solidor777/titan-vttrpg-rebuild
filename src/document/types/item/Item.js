...
import TitanAbility from '~/document/types/item/types/ability/Ability.js';
import TitanArmor from '~/document/types/item/types/armor/Armor.js';
import TitanEffect from '~/document/types/item/types/effect/Effect.js';
import TitanEquipment from '~/document/types/item/types/equipment/Equipment.js';
import TitanShield from '~/document/types/item/types/shield/Shield.js';
import TitanSpell from '~/document/types/item/types/spell/Spell.js';
import TitanWeapon from '~/document/types/item/types/weapon/Weapon.js';
