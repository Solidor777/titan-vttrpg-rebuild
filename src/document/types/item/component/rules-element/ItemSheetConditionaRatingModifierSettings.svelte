<script>
   ...
   import DocumentRangeTypeSelect from '~/document/components/select/DocumentRangeTypeSelect.svelte';
   ...
   import DocumentArmorTraitSelect from '~/document/components/select/DocumentArmorTraitSelect.svelte';
   import DocumentShieldTraitSelect from '~/document/components/select/DocumentShieldTraitSelect.svelte';
