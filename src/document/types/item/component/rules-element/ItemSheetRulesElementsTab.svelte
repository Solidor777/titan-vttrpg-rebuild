<script>
   ...
   import ItemSheetFlatModifierSettings from '~/document/types/item/component/rules-element/ItemSheetFlatModifierSettings.svelte';
   import ItemSheetMulBaseSettings from '~/document/types/item/component/rules-element/ItemSheetMulBaseSettings.svelte';
   import ItemSheetTurnMessageSettings from '~/document/types/item/component/rules-element/ItemSheetTurnMessageSettings.svelte';
   import ItemSheetFastHealingSettings from '~/document/types/item/component/rules-element/ItemSheetFastHealingSettings.svelte';
   import ItemSheetPersistentDamageSettings from '~/document/types/item/component/rules-element/ItemSheetPersistentDamageSettings.svelte';
   import ItemSheetRollMessageSettings from '~/document/types/item/component/rules-element/ItemSheetRollMessageSettings.svelte';
   import ItemSheetConditionaRatingModifierSettings from '~/document/types/item/component/rules-element/ItemSheetConditionaRatingModifierSettings.svelte';
   import ItemSheetConditionaCheckModifierSettings from '~/document/types/item/component/rules-element/ItemSheetConditionaCheckModifierSettings.svelte';
   import ItemSheetInvalidRulesElement from '~/document/types/item/component/rules-element/ItemSheetInvalidRulesElement.svelte';
