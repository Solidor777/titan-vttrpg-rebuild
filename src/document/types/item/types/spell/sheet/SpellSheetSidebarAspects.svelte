<script>
   ...
   import SpellSheetSidebarCustomAspect from '~/document/types/item/types/spell/sheet/SpellSheetSidebarCustomAspect.svelte';
   import SpellSheetSidebarStandardAspect from '~/document/types/item/types/spell/sheet/SpellSheetSidebarStandardAspect.svelte';
